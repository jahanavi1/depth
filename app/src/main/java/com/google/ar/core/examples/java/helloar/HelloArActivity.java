...
import com.google.ar.core.examples.java.measurement.CpuImageRenderer;
import com.google.ar.core.examples.java.raw.rawdepth.RawDepthActivity;
...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  private TextView tvResoulation;
  private TextView tvDepthApi;

  private ImageView selectSec;

  private ImageView playbackButton;
  private ImageView recordbackButton;

  private boolean installRequested;
  private boolean isFullOrRow = false;
...
//    imageView = findViewById(R.id.playback_button);
...
//  private final FrameTimeHelper cpuImageFrameTimeHelper = new FrameTimeHelper();
  ...
  private void updateUI() {
    switch (currentState.get()) {
      case Idle:
        ...
        recordbackButton.setVisibility(View.INVISIBLE);
        break;
      case Recording:
        playbackButton.setVisibility(View.VISIBLE);
        recordbackButton.setVisibility(View.INVISIBLE);
  ...
  private void updatePlaybackButton() {
    ...
    switch (appState) {
      ...
      case Idle:
        recordbackButton.setImageResource(R.drawable.baseline_replay_circle_filled_24);
        playbackButton.setVisibility(View.VISIBLE);
        recordbackButton.setVisibility(View.VISIBLE);
        break;

      // While playing back, the "Playback" button is visible and says "Stop".
      case Playingback:
        recordbackButton.setImageResource(R.drawable.baseline_stop_circle_24);
  ...
  private boolean startPlayingback(Uri mp4FileUri) {
    ...
    try {
      ...
      setStateAndUpdateUI(AppState.Playingback);
